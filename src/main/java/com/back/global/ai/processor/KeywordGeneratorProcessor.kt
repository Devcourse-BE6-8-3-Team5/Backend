...
class KeywordGeneratorProcessor(
    ...
    override fun buildPrompt(): String {
        return """
            ...
            현재 날짜: ${keywordGenerationReqDto.currentDate}
            ...
            **웹 검색 결과를 바탕으로** 다음을 우선 고려:
            ...
            [기존 레포지토리 키워드 활용]
            다음은 최근 사용된 키워드들과 그 타입입니다: ${keywordGenerationReqDto.recentKeywordsWithTypes}
            ...
            [제외 키워드]
            다음 키워드들은 최근 과도하게 사용되어 제외해주세요: ${keywordGenerationReqDto.excludeKeywords}
