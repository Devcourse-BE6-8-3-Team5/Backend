...
class TestInitData(
    ...
    fun newsInit() {
        ...
        if (!savedNewsList.isEmpty()) {
            newsDataService.setTodayNews(savedNewsList[1].id)
        }
    }
