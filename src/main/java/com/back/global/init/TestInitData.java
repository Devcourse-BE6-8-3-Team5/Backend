...
public class TestInitData {
    ...
    public void newsInit() {
        ...
        // 뉴스 1: 경제 카테고리
        RealNewsDto news1 = new RealNewsDto(
                1L,
        ...
        // 뉴스 2: 생활 카테고리
        RealNewsDto news2 = new RealNewsDto(
                2L,
        ...
        RealNewsDto news3 = new RealNewsDto(
                3L,
        ...
        RealNewsDto news4 = new RealNewsDto(
                4L,
        ...
        RealNewsDto news5 = new RealNewsDto(
                5L,
        ...
        RealNewsDto news6 = new RealNewsDto(
                6L,
        ...
        RealNewsDto news7 = new RealNewsDto(
                7L,
        ...
        RealNewsDto news8 = new RealNewsDto(
                8L,
        ...
        if (!savedNewsList.isEmpty()) {
            newsDataService.setTodayNews(savedNewsList.get(1).getId());
        }
    }
